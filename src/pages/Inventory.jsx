...
const Inventory = () => {
  ...
  useEffect(() => {
    // Permission না থাকলে কোনো API call হবে না.
    // এখানে কোনো synchronous setState নেই.
    if (!canViewInventory) {
      return;
    }
